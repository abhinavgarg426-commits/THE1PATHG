...
const UPANISHADS = [
    {
        ...
        verses: [
            ...
            { sanskrit: "कुर्वन्नेवेह कर्माणि जिजीविषेच्छतं समाः। एवं त्वयि नान्यथेत्थं स्यादित्थं शून्येषु वस्तुषु॥", translit: "Kurvanneva iha karmani jijivishech chatam samah. Evam tvayi nanyathetham syad itham shunyeshv vastushu.", translation: "Perform your duties here in the world for a hundred years. Live actively in this world — do not become one who is useless, empty, or dead while still alive.", ref: "Isha Upanishad 2" },
            { sanskrit: "अज एकजो नित्योऽनन्तोऽयमात्मा सुप्रसादः। न जायते म्रियते वा नापरः कदाचित्। न हि जातस्य मृत्युर्भवति नित्यस्य शश्वतः।", translit: "Aja eko nityo 'nanto 'yam atma supra-sadah. Na jayate mriyate va naparah kadachit. Na hi jatasya mritur bhavati nityasya shashvatah.", translation: "The soul is one, unborn, eternal, infinite. It does not die when the body dies. For the immortal soul, there is no death — only transformation.", ref: "Isha Upanishad 3" },
            ...
            { sanskrit: "यदा चर्मवदाकाशं वस्त्र इव जलं शरवत्। पुनरग्रथितं द्रष्टृ न चलति तदा मुनेर्मनो योगेन सम्पन्नं भवति॥", translit: "Yada charma-vad akasham vastra iva jalam sharavat. Punar agrathitam drashtri na chalati tada muner mano yogen sampannam bhavati.", translation: "When the wise one perceives the self as the unbounded sky within the body — like space in a pot, unbroken — they become one with the infinite. Their mind, perfected through yoga, rests in stillness.", ref: "Isha Upanishad 7" }
        ]
    },
    {
        name: "Kena Upanishad",
